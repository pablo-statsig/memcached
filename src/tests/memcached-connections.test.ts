...
//     let memcached = new Memcached('127.0.1:1234', { retries: 3 })
//       , calls = 0
...
//     let memcached = new Memcached('127.0.1:1234', {
//       timeout: 1000,
//       retries: 0,
//       failures: 0,
//       retry: 100,
...
//     let memcached = new Memcached(['127.0.1:1234', common.servers.single], {
//       timeout: 1000,
//       retries: 0,
//       failures: 0,
//       retry: 100,
...
//     let server = '127.0.0.1:1234'
//     let memcached = new Memcached(server, {
//       retries: 0,
//       failures: 5,
//       retry: 100 })
...
//       assert.deepEqual((memcached as any).issues[server].failures, 5)
//       assert.deepEqual((memcached as any).issues[server].locked, true)
//       assert.deepEqual((memcached as any).issues[server].failed, true)
...
//           assert.deepEqual((memcached as any).issues[server].locked, false)
//           assert.deepEqual((memcached as any).issues[server].failed, false)
//           memcached.get('idontcare', function(err) {
//             // Server should be marked healthy again, though we'll get this error
//             assert.throws(function() { throw err }, /connect ECONNREFUSED/)
//             assert.deepEqual((memcached as any).issues[server].failures, 4)
//             memcached.end()
//             done()
//           })
...
//                 memcached.get('idontcare', function(err) {
//                   assert.throws(function() { throw err }, /connect ECONNREFUSED/)
//                   assert.deepEqual((memcached as any).issues[server].failures,
...
//     let server = '10.255.255.255:1234'
//     , memcached = new Memcached(server, {
//       retries: 0,
//       timeout: 100,
//       idle: 1000,
...
//       let S = memcached.connections[common.servers.single].pool.pop()
...
//       setTimeout(function() {
//         assert.deepEqual((memcached as any).issues[server].failures, 1)
